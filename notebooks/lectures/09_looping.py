...
def _():
    ...
    for _letter in 'abcdefghijklmnopqrstuvwxyz':
        if _letter in vowels:
            continue
        consonants.append(_letter)  # Go back to the top of the loop and look at the next item;
    print(len(consonants))  # don't go any further in the body of the loop for this particular iteration  # This line won't be run if the letter is a vowel, since we "continue" above for all vowels
    return
...
def _():
    ...
    while _i > 0:
        ...
        if _i % 7 == 0:
            break
        _i -= 1
    print(f'The biggest multiple of 7 less than 100 is {_i}.')  # Decrement operator, equivalent to i = i - 1
    return
